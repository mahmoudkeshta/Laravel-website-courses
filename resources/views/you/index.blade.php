        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="{{ asset('cms/assets/images/HTML1.jpg') }}" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Full HTML Course</h4></a>
                <h6>$25.75</h6>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="{{ asset('cms/assets/images/css1jpg.jpg') }}" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Full CSS Course</h4></a>
                <h6>$30.25</h6>
                <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="{{ asset('cms/assets/images/logo-bootstrap.png') }}" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Full BootStrap3 Course</h4></a>
                <h6>$20.45</h6>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <p>Copyright &copy; 2021 Courses<a rel="nofollow noopener" href="https://templatemo.com" target="_blank">TemplateMo</a></p>
            </div>
          </div>
        </div>
      </div>
